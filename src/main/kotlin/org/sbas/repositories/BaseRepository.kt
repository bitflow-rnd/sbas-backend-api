...
class BaseAttcRepository : PanacheRepositoryBase<BaseAttc, String> {
  ...
  fun getNextValAttcGrpId(): String {
    ...
    return "ATG" + nextValue.toString().padStart(7, '0')
  }

  fun getNextValAttcId(): String {
    val nextValue = getEntityManager().createNativeQuery("select nextval('base_attc_id_seq')").singleResult
    return "AT" + nextValue.toString().padStart(10, '0')
  }
}